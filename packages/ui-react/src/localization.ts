...
const EN_MESSAGES = {
  ...
  "ui.inspector.progress": "Progress",
  "ui.inspector.progressNone": "No active progress",
  "ui.inspector.progressValue": "{progress}%",
  "ui.inspector.reason": "Reason",
  "ui.inspector.reasonNone": "No active reason",
  "ui.inspector.roleSummary": "{role} · {summary}",
  "ui.inspector.selected": "Selected entity",
  "ui.inspector.target": "Target",
  "ui.inspector.terrain": "Terrain",
  "ui.inspector.terrainUnknown": "Unknown terrain",
  "ui.inspector.taskState": "Task state",
  ...
  "ui.entityKind.resource": "resource",
  ...
  "ui.task.job.buildConstruction": "Build construction",
  "ui.task.job.buildDelivery": "Build delivery",
  "ui.task.job.lampRefill": "Lamp refill",
  "ui.task.state.blocked": "Blocked",
  "ui.task.state.canceled": "Canceled",
  "ui.task.state.claimable": "Claimable",
  "ui.task.state.claimed": "Claimed",
  "ui.task.state.completed": "Completed",
  "ui.task.state.failed": "Failed",
  "ui.task.state.idle": "Idle",
  "ui.task.state.moving": "Moving",
  "ui.task.state.queued": "Queued",
  "ui.task.state.working": "Working",
...
const ZH_CN_MESSAGES = {
  ...
  "ui.surface.topBarMeta": "{cycle} | {map} | {speed}",
  "ui.inspector.progress": "进度",
  "ui.inspector.progressNone": "暂无执行进度",
  "ui.inspector.progressValue": "{progress}%",
  "ui.inspector.reason": "原因",
  "ui.inspector.reasonNone": "当前无结构化原因",
  "ui.inspector.target": "目标",
  "ui.inspector.taskState": "任务状态",
  "ui.hud.actionFeedback.accepted": "已接受",
  "ui.hud.actionFeedback.progress": "进度：{progress}%",
  ...
  "ui.task.state.blocked": "阻塞",
  "ui.task.state.canceled": "已取消",
  "ui.task.state.claimable": "可认领",
  "ui.task.state.claimed": "已接单",
  "ui.task.state.completed": "已完成",
  "ui.task.state.failed": "失败",
  "ui.task.state.idle": "空闲",
  "ui.task.state.moving": "移动中",
  "ui.task.state.queued": "已排队",
  "ui.task.state.working": "工作中",
