...
function parseReplayDiagnosticArgs(rawArgs) {
  ...
  for (let index = 0; index < args.length; index += 1) {
    ...
    return {
      ok: false,
      error:
        "Unsupported replay diagnostics arguments. Use --scenario m2-work-logistics, --scenario m3-ordinary-life, --scenario m4-core-vertical-slice, --scenario m5-alpha-content-framework, --seed <seed>, or --artifact-root <path>.",
    };
  }
