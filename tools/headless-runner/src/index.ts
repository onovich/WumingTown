...
function runSelectedHeadlessScenario(
  ...
  if (options.scenario === PR1_INTEGRATED_GAME_SESSION_ALIAS) {
    return runPr1IntegratedGameSessionScenario({ seed: options.seed, ticks: options.ticks });
  }
